...
<?php 
    ...
    if($_POST) {
        ...
        if ($nomeok && $precook && $photook) {
            $query = $bancodedadosdesafio -> prepare("INSERT INTO produtos (nome, descricao, preco, photo) VALUES (:nome, :descricao, :preco, :photo);");
            $funcionou = $query -> execute([':nome' => $nome,':descricao' => $descricao,':preco' => $preco,':photo' => $photo]);
...
?>
    ...
    <div class="container">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <label for="photo">Foto do Produto</label><br>
